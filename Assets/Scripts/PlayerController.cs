...
public class PlayerController : MonoBehaviour {
    ...
    private class Jumping : PlayerState
    {
        ...
        public void Enter()
        {
             ...
             */
            // ***
            if (moveJump > 0 && Input.GetButton("Jump"))
            {
                rb.AddForce(new Vector3(0, 10*jumpForce));
        ...
        public void FixedUpdate()
        {
            ...
            Debug.Log(airHorizAcceleration);
            ...
            {
                rb.AddForce(new Vector2(airHorizAcceleration * 10*moveX, 0));
            }
            if (jumpingTime > 0 && Input.GetButton("Jump"))
            {
                Debug.Log("long press");
                rb.AddForce(new Vector2(0, airJumpAcceleration * 10 * moveJump));
            }
            // ***
